...
public class DataSetImage {
    ...
    public DataSetImage(ImageFrame frame, LinkedList<Double> values, ColorRangeIterator iterator) {
        this.frame = frame;
        this.values = values;
    ...
    private void paint(Graphics2D graphics2D) {
        ...
        var factory = new RectangleFactory(values, frame);
        ...
        for (int index = 0; index < values.size(); index += 2) {
            ...
            else graphics2D.fill(factory.buildFor(index, vertical));
        }
